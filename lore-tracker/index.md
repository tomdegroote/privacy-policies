...
## Overview
We believe in privacy and collect only the minimum data necessary for basic app functionality and improvement. 
This privacy policy explains what limited information we collect and how we protect your privacy.
...
You can clear this data at any time by clearing the app's cache or storage.

## Required Permissions
The app requires internet access only for anonymous analytics. All core functionality (score tracking, settings) works completely offline.
You can block internet access and the app will function normally without any analytics.
